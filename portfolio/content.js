    ...
    projects: [
      {
        ...
        problem: "문서 중심 검토로 맥락 전달이 끊기고, 컨펌 리드타임이 길었습니다.",
        approach: "프로토타입과 웹 배포를 연결한 AX 기반 검토 흐름을 설계해 문서 설명과 화면 확인을 한 번에 이어지게 만들었습니다.",
        impact: "초기 검토 인원을 3명에서 1명으로 줄이고, 리드타임을 1주에서 3일로 단축했습니다.",
      ...
      },
      {
        ...
        problem: "UX 표현과 판단 기준이 모호해 기획과 디자인의 해석이 자주 갈렸습니다.",
        approach: "추상적인 표현을 기능 정의, 예외 케이스, 의사결정 트리 중심으로 재구성해 실무용 가이드라인으로 정리했습니다.",
        impact: "공통 검토 기준을 문서화해 논의 비용을 줄이고 의사결정 기준을 정렬했습니다.",
        tools: ["Claude Code"],
      ...
      },
      {
        ...
        problem: "본선 200명 목표를 유지해야 했고, 전년도엔 운영 손실이 컸습니다.",
        approach: "참가 구조와 운영 스케줄을 다시 설계하고, 비용과 전환 지표를 함께 보며 손실이 커지는 구간을 조정했습니다.",
        impact: "본선 목표를 유지한 채 전년 대비 손실 폭을 약 50% 줄였습니다.",
        tools: ["Business English", "Data Analysis"],
    ...
    projects: [
      {
        ...
        problem: "A document-heavy review flow kept losing context and slowing approvals.",
        ...
        impact: "Reduced initial reviewers from 3 to 1 and cut lead time from one week to three days.",
        tools: ["Claude Code", "GitHub"],
      ...
      },
      {
        ...
        problem: "Vague UX language made planning and design work from different interpretations.",
        ...
        impact: "Created a shared standard that reduced interpretation gaps and made reviews more consistent.",
        tools: ["Claude Code"],
        href: "../case-ux-guideline-en.html",
        cta: "Learn More",
      },
      {
        title: "Local Event Operations Support",
        meta: "NSUSLAB Korea | Dec 2023 - Jan 2024",
        problem: "We had to keep the 200-finalist goal while addressing a costly event structure.",
        ...
        impact: "Maintained the target and cut losses by roughly 50% versus the previous year.",
        tools: ["Business English", "Data Analysis"],
