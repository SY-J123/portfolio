    ...
    projects: [
      {
        ...
        goal: [
          ...
          "새로운 업무 프로세스에 동료들이 쉽게 적응할 수 있도록한다.",
          "지속 가능성을 위해 토큰 사용량 및 작업 속도를 최적화한다."
        ],
        approach: [
          "와이어 프레임과 스토리보드를 바이브 코딩 프로토타입으로 대체했다.",
          "하나의 기획에 대해 PRD, 정책, 개발문서를 하나의 html 파일로 제작했다.",
          "Github을 통해 문서와 프로토타입의 버전을 관리했다.",
          "Claude Code 에이전트를 생성하여 주기적으로 문서의 정합성과 논리적 오류를 검사했다.",
          "Claude Code 에이전트를 생성하여 반복적으로 코드를 모듈화했다."
        ],
        impact: [
          "프로토타입 제작 투입 인원 3명 → 1명",
          "리드타임 1주 → 3일 단축",
          "모든 커밋에 대한 변경사항 AI로 추적 자동화",
        ],
        appendix: [
          "프로토타입 링크 기반 검토 흐름",
          "블러 처리한 시연 영상",
      ...
      },
      {
        ...
        problem: [
          "지난 해 해외 지사에서 주최한 이벤트에서 적자가 발생했다.",
          "지난 해 담당자가 가특정 오프라인 본선 200명 목표는 그대로 유지해야 했다.",
        ],
        goal: [
