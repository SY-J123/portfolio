    ...
    projects: [
      {
        ...
        problem: [
          "텍스트 중심 문서만으로는 화면 흐름과 기획 의도를 한 번에 전달하기 어려웠습니다.",
          "PoC 검토마다 반복 설명과 재확인이 발생해 리드타임이 길어졌습니다.",
        ],
        goal: [
          "PoC 검토와 컨펌 리드타임을 줄입니다.",
          "적은 인원으로도 같은 맥락에서 빠르게 판단할 수 있게 만듭니다.",
        ],
        approach: [
          "기획자가 직접 로우파이 프로토타입을 제작해 화면 흐름을 함께 공유했습니다.",
          "GitHub와 웹 배포를 연결해 항상 같은 기준 문서를 보도록 구조를 맞췄습니다.",
          "Claude Code로 반복 문서 정리 작업을 줄였습니다.",
        ],
        impact: [
          "PoC를 위한 프로토타입 제작 투입 인원 3명에서 1명으로 축소",
          "리드타임 1주일에서 3일로 단축",
        ],
        appendix: [
          "프로토타입 링크 기반 검토 흐름",
    ...
    projects: [
      {
        ...
        problem: [
          "Text-heavy documents were not enough to communicate screen flows and planning intent clearly in a single pass.",
          "PoC reviews kept generating repeated explanations and reconfirmation, which stretched lead time.",
        ],
        goal: [
          "Reduce review and approval lead time for PoC work.",
          "Help a smaller group align quickly around the same context.",
        ],
        approach: [
          "I built low-fidelity prototypes myself so screens and flow could be reviewed together.",
          "I connected GitHub and web publishing so stakeholders could review from one shared source.",
          "I used Claude Code to reduce repetitive documentation work.",
        ],
        impact: [
          "Reduced prototype staffing for PoC work from 3 people to 1",
          "Shortened lead time from 1 week to 3 days",
        ],
        appendix: [
