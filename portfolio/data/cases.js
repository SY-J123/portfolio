...
const caseContent = {
  "case-ai-doc-process": {
    ko: {
      description: "문서 중심 협업을 더 빠른 검토 구조로 바꾼 AX 프로젝트 요약",
      title: "AI 기반 문서 협업 프로세스 개선",
      meta: "LULU.AI · 25년 12월 ~ 26년 3월",
      headline: "문서, 프로토타입, 웹 배포를 연결해 PoC 검토 구조를 더 빠르게 만든 프로젝트입니다.",
      sections: [
        { id: "problem", title: "문제 정의", items: ["텍스트 중심 문서만으로는 화면 흐름과 기획 의도를 한 번에 전달하기 어려웠습니다.", "PoC 검토마다 반복 설명과 재확인이 발생해 리드타임이 길어졌습니다."] },
        { id: "goal", title: "목표", items: ["PoC 검토와 컨펌 리드타임을 줄입니다.", "적은 인원으로도 같은 맥락에서 빠르게 판단할 수 있게 만듭니다."] },
        { id: "approach", title: "방법", items: ["기획자가 직접 로우파이 프로토타입을 제작해 화면 흐름을 함께 공유했습니다.", "GitHub와 웹 배포를 연결해 항상 같은 기준 문서를 보도록 구조를 맞췄습니다.", "Claude Code로 반복 문서 정리 작업을 줄였습니다."] },
        { id: "impact", title: "성과", items: ["PoC를 위한 프로토타입 제작 투입 인원 3명에서 1명으로 축소", "리드타임 1주일에서 3일로 단축"] },
        { id: "appendix", title: "Appendix", items: ["프로토타입 링크 기반 검토 흐름", "블러 처리한 시연 영상"] },
      ],
    },
    en: {
      description: "A case study on improving document-heavy collaboration through prototypes and publishing workflows.",
      title: "AI-Driven Document Collaboration Process Improvement",
      meta: "LULU.AI · Dec 2025 - Mar 2026",
      headline: "A project that connected documents, prototypes, and publishing flow to make PoC review faster.",
      sections: [
        { id: "problem", title: "Problem", items: ["Text-heavy documents were not enough to communicate screen flow and planning intent clearly in a single pass.", "Repeated explanation and reconfirmation during PoC review kept stretching lead time."] },
        { id: "goal", title: "Goal", items: ["Reduce review and approval lead time for PoC work.", "Help a smaller group align faster around the same context."] },
        { id: "approach", title: "Approach", items: ["I built low-fidelity prototypes myself so screens and flow could be reviewed together.", "I connected GitHub and web publishing so stakeholders could review from one shared source.", "I used Claude Code to reduce repetitive documentation work."] },
        { id: "impact", title: "Impact", items: ["Reduced prototype staffing for PoC work from 3 people to 1", "Shortened lead time from 1 week to 3 days"] },
